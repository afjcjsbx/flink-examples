...
object Match {
    ...
    def fromJson(json: String): Match = objectMapper.readValue(json, classOf[Match])

    def toJson(event: Match): String = objectMapper.writeValueAsString(event)
...
case class Match(
    ...
    def toJson: String = Match.toJson(this)
